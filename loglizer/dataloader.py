...
def load_HDFS(log_file, label_file=None, window='session', train_ratio=0.5, split_type='sequential', save_csv=False, window_size=0):
    ...
    if log_file.endswith('.npz'):
        ...
        """ README
        in data_df vengono associati i block_id all'event_id
            0     blk_38865049064139660       [dc2c74b7]
            1     blk_-6952295868487656571    [dc2c74b7]
         """
        ...
        if label_file:
            ...
            """ README
            in data_df si aggiunge la label di riferimento (anomalia o non)
                blk_-8523968015014407246    ['e3df2680']    0
                blk_8181993091797661153     ['5d5de21c']    1
            """
...
def load_BGL(log_file, window='session', train_ratio=0.5, split_type='sequential', save_csv=False, window_size=0):
    """  TODO

    """
    if log_file.endswith('.csv'):
        assert window == 'session', "Only window=session is supported for BGL dataset."
        print("Loading", log_file)
        ...
        """ README
        in data_df vengono associati i nodes all'event_id
            0     R02-M1-N0-C:J12-U11   [3aa50e45, 3aa50e45, 3aa50e45, 3aa50e45, 3aa50...
            1     R23-M0-NE-C:J05-U01   [6265c739]
         """
        if save_csv:
            data_df.to_csv('data_instances.csv', index=False)
